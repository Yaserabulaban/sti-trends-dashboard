...
import { burdenColor, chartColors, countryKey, filteredRows, formatValue, getRowValue, getValueLabel, getYearLabel, tooltipRows } from "./utils.js?v=dashboard-story-tooltip-20260705";
...
export function renderChoroplethMap(rows, world, state) {
  ...
  d3.select("#map-subtitle").text(`${getValueLabel(state)} by country | ${yearLabel}`);
